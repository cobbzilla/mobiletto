 ...
 * `s3` `bucket` ንብረት ያስፈልጋል። አማራጭ ንብረቶች የሚከተሉት ናቸው
 ...
 ### የምዝግብ ማስታወሻ ደረጃ
 የምዝግብ ማስታወሻውን ደረጃ `MOBILETTO_LOG_LEVEL` አካባቢ ተለዋዋጭ ይጠቀሙ፣ አንዱን በመጠቀም
 ...
 ነባሪው ደረጃ `error` ነው። ምንም እንኳን በአሁኑ ጊዜ ሞባይልቶ ቢሆንም በጣም የቃል ደረጃው `silly` ነው።
 ...
 የአካባቢ ተለዋዋጭ. ወደ ፋይል ሲገቡ፣ ምዝግብ ማስታወሻዎች ወደ ኮንሶሉ ላይ አይጻፉም።
