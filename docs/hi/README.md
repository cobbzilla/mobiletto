 ...
 * `s3` के लिए, `bucket` संपत्ति आवश्यक है। वैकल्पिक गुण हैं:
 ...
 लॉग्स **में** फ़ाइल पथ और त्रुटि संदेश होंगे, लेकिन **कभी भी ** में कुंजी, रहस्य नहीं होंगे,
 या कोई अन्य कनेक्शन कॉन्फ़िगरेशन जानकारी।

 ### छांटने का स्तर
 एक का उपयोग करके लॉग स्तर सेट करने के लिए `MOBILETTO_LOG_LEVEL` पर्यावरण चर का उपयोग करें
