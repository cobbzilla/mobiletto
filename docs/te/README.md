 ...
 * `s3` కోసం, `bucket` ప్రాపర్టీ అవసరం. ఐచ్ఛిక లక్షణాలు:
 ...
 ### లాగ్ స్థాయి
 ఒకదాన్ని ఉపయోగించి లాగ్ స్థాయిని సెట్ చేయడానికి `MOBILETTO_LOG_LEVEL` ఎన్విరాన్‌మెంట్ వేరియబుల్ ఉపయోగించండి
 ...
 డిఫాల్ట్ స్థాయి `error` . ప్రస్తుతం mobiletto అయినప్పటికీ అత్యంత పదజాలం స్థాయి `silly` సిల్లీ`
