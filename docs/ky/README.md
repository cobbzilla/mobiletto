 ...
 * `s3` үчүн, `bucket` касиети талап кылынат. Кошумча касиеттери болуп төмөнкүлөр саналат:
 ...
 ## Каттоо
 Mobiletto [winston](https://www.npmjs.com/package/winston) журнал китепканасын колдонот.
 ...
 ### Журнал деңгээли
 Журналдын деңгээлин коюу үчүн `MOBILETTO_LOG_LEVEL` чөйрө өзгөрмөсүн колдонуңуз.
